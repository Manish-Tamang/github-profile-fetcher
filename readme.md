...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/Manish-Tamang/github-profile-fetcher.git
...
# Credits
Built by [Manish Tamang/Manish-Tamang]

** Utilizes shadcn/ui component library and Next.js for it's UI and framework. **